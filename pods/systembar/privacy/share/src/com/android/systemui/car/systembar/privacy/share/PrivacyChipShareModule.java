...
/** Dagger module for Share Privacy Chip. */
@Module
public abstract class PrivacyChipShareModule {
    /** Inject ShareToAppPrivacyChipViewController.Factory. */
    @Binds
    @IntoMap
    @ClassKey(ShareToAppPrivacyChipViewController.class)
    public abstract CarSystemBarElementController.Factory
            bindShareToAppPrivacyChipViewControllerFactory(
