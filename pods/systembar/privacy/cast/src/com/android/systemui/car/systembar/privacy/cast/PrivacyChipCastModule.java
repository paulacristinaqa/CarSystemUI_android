...
/** Dagger module for Cast Privacy Chip. */
@Module
public abstract class PrivacyChipCastModule {
    /** Inject CastToOtherDevicePrivacyChipViewController.Factory. */
    @Binds
    @IntoMap
    @ClassKey(CastToOtherDevicePrivacyChipViewController.class)
    public abstract CarSystemBarElementController.Factory
            bindCastToOtherDevicePrivacyChipViewControllerFactory(
